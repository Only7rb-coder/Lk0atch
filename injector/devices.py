...
DEVICES = [
    ...
    Device(
        'xiaomi_redmi_note_14_4g',
        ' Xiaomi Redmi Note 14 4G',
        {
            'force_green_state': PatchStage(
                'force_green_state',
                pattern='67 72 65 65 6e 00 62 61 74 74 65 72 79 5f 69 64 3d 31 00 73 74 69 63 6b 65 72 72 20 72 65 61 64',
                replacement='28 03 00 b0 1f 49 02 b9 c0 03 5f d6',
                match_mode=MatchMode.ALL,
                description='Force boot state to always be set to green',
            ),
            'bypass_cmd_erase_lock_control': PatchStage(
                'bypass_cmd_erase_lock_control',
                pattern='00 65 72 61 73 65 00 66 61 73 74 62 6f 6f 74 3a 20 6f 6f 70 73 21 0a 00 73 65 74 5f 61 63 74 69',
            ...
            'bypass_cmd_flash_control': PatchStage(
                'bypass_cmd_flash_control',
                pattern='00 66 6c 61 73 68 00 73 65 72 69 61 6c 6e 6f 00 62 6f 6f 74 2d 72 65 63 6f 76 65 72 79 00 69 6e',
            ...
            'spoof_lock_state': PatchStage(
                'spoof_lock_state',
                pattern='74 5f 6c 6f 63 6b 5f 73 74 61 74 65 00 72 65 73 65 72 76 65 2d 6d 65 6d 6f 72 79 2d 73 63 70 5f',
